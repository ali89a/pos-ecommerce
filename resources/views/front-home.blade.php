                                ...
                                <div class="extraslider-inner products-list yt-content-slider" data-rtl="yes"
                                    ...
                                    <div class="item product-layout product-grid2">
                                        <div class="product-thumb transition product-item-container">
                                                    ...
                                                    <div class="image">
                                                        ...
                                                        <a href="#" target="_self" title="product">
                                                            <img src="{{ asset('front') }}/image/product/2.jpg"
                                                                alt="Hofficia chicken" class="img-responsive">
                                                        </a>
                                                    </div>
                                                    <!--quickview-->
                                                    <div class="so-quickview">
                                            ...
                                            <div class="right-block">
                                                <div class="caption">
                                                    <h4><a href="#" target="_self" title="Hofficia chicken">Hofficia
                                                            chicken</a></h4>
                                                    <div class="rating">
                                                        <span class="fa fa-stack"><i
                                                                class="fa fa-star fa-stack-2x"></i></span>
                                    ...
                                    <div class="item product-layout product-grid2">
                                        <div class="product-thumb transition product-item-container">
                                            <div class="left-block">
                                                <div class="product-image-container">
                                                    <div class="image">
                                                        ...
                                                        <a href="#" target="_self" title="product">
                                                            <img src="{{ asset('front') }}/image/product/3.jpg"
                                                                alt="Lastrami deserunt" class="img-responsive">
                                                        </a>
                                                    </div>
                                                    <!--quickview-->
                                                    <div class="so-quickview">
                                            ...
                                            <div class="right-block">
                                                <div class="caption">
                                                    <h4><a href="#" target="_self" title="Lastrami deserunt">Lastrami
                                                            deserunt</a></h4>
                                                    <div class="rating">
                                                        <span class="fa fa-stack"><i
                                                                class="fa fa-star fa-stack-2x"></i></span>
                                            ...
                                            <div class="product-thumb transition product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container">
                                                        <div class="image">
                                                            <a href="#" target="_self" title="product">
                                                                <img src="{{ asset('front') }}/image/product/10.jpg"
                                                ...
                                                <div class="right-block">
                                                    <div class="caption">
                                                        <h4><a href="#" target="_self"
                                                                title="Mapicola incididuv">Mapicola incididuv
                                                            </a></h4>
                                                        <div class="rating">
                                                            <span class="fa fa-stack"><i
                                                                    class="fa fa-star fa-stack-2x"></i></span>
                                        ...
                                        <div class="product-layout product-grid2 style1">
                                            <div class="product-thumb transition product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container">
                                                        <div class="image">
                                                            ...
                                                            <a href="#" target="_self" title="product">
                                                                <img src="{{ asset('front') }}/image/product/4.jpg"
                                                                    alt="Benderloin officia" class="img-responsive">
                                                            </a>
                                                        </div>
                                                        <!--quickview-->
                                                        <div class="so-quickview">
                                                ...
                                                <div class="right-block">
                                                    <div class="caption">
                                                        <h4><a href="#" target="_self"
                                                                title="Benderloin officia">Benderloin
                                                                officia</a></h4>
                                                        <div class="rating">
                                                            <span class="fa fa-stack"><i
                                                                    class="fa fa-star fa-stack-2x"></i></span>
                                            ...
                                            <div class="product-thumb transition product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container">
                                                        <div class="image">
                                                            <a href="#" target="_self" title="product">
                                                                <img src="{{ asset('front') }}/image/product/5.jpg"
                                                                    alt="Rumstick shankle" class="img-responsive">
                                                            </a>
                                                        </div>
                                                        <!--quickview-->
                                                        <div class="so-quickview">
                                                ...
                                                <div class="right-block">
                                                    <div class="caption">
                                                        <h4><a href="#" target="_self" title="Rumstick shankle">Rumstick
                                                                shankle</a>
                                                        </h4>
                                                        <div class="rating">
                                                            <span class="fa fa-stack"><i
                        ...
                        <div class="content-box">
                            <div class="image-cat">
                                <a href="#" title="Smartphone" target="_self">
                                    <img src="{{ asset('front') }}/image/catalog/demo/category/id4-cat1.jpg"
                        ...
                        <div class="content-box">
                            <div class="image-cat">
                                <a href="#" title="Fashion" target="_self">
                                    <img src="{{ asset('front') }}/image/catalog/demo/category/id4-cat2.jpg"
                        ...
                        <div class="content-box">
                            <div class="image-cat">
                                <a href="#" title="Sport bikes " target="_self">
                                    <img src="{{ asset('front') }}/image/catalog/demo/category/id4-cat3.jpg"
                        ...
                        <div class="content-box">
                            <div class="image-cat">
                                <a href="#" title="Furniture & Decor" target="_self">
                                    <img src="{{ asset('front') }}/image/catalog/demo/category/id4-cat4.jpg"
                        ...
                        <div class="content-box">
                            <div class="image-cat">
                                <a href="#" title="Appliances" target="_self">
                                    <img src="{{ asset('front') }}/image/catalog/demo/category/id4-cat5.jpg"
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image">
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{ asset('front') }}/image/product/6.jpg"
                                                            alt="Ground round enim" class="img-responsive">
                                                    </a>
                                                </div>
                                                <!--quickview-->
                                    ...
                                    <div class="product-thumb transition product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image">
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{ asset('front') }}/image/product/7.jpg"
                                                            alt="Mapicola incididuv " class="img-responsive">
                                                    </a>
                                                </div>
                                                <!--quickview-->
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                <h4><a href="#" target="_self" title="Mapicola incididuv">Mapicola
                                                        incididuv </a></h4>
                                                <div class="rating">
                                                    <span class="fa fa-stack"><i
                                                            class="fa fa-star fa-stack-2x"></i></span>
                                    ...
                                    <div class="product-thumb transition product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image">
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{ asset('front') }}/image/product/8.jpg"
                                                            alt="Corem ipsum dolor" class="img-responsive">
                                                    </a>
                                                </div>
                                                <!--quickview-->
                            ...
                            <div class="item ">
                                <div class="product-layout product-grid2 style1">
                                    <div class="product-thumb transition product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image">
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{ asset('front') }}/image/product/9.jpg"
                                                            alt="Benderloin officia" class="img-responsive">
                                                    </a>
                                                </div>
                                                <!--quickview-->
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                <h4><a href="#" target="_self" title="Benderloin officia">Benderloin
                                                        officia</a></h4>
                                                <div class="rating">
                                                    <span class="fa fa-stack"><i
                                                            class="fa fa-star fa-stack-2x"></i></span>
