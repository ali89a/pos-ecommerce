                                    ...
                                    <div class="item product-layout product-grid2">
                                        <div class="product-thumb transition product-item-container">
                                            ...
                                            <div class="right-block">
                                                <div class="caption">
                                                    <h4><a href="#" target="_self" title="Ground round enim">{{$publishedProduct->name}}</a>
                                                    </h4>
                                                    <div class="rating">
                                                    ...
                                                    <p class="price">
                                                        @if($publishedProduct->discount > 0)
                                                        <span class="price-new">৳ {{$publishedProduct->selling_price - $publishedProduct->discount}}</span>
                                            ...
                                            <div class="product-thumb transition product-item-container">
                                                ...
                                                <div class="right-block">
                                                    <div class="caption">
                                                        ...
                                                        <p class="price">
                                                            @if($product->discount > 0)
                                                            <span class="price-new">৳ {{$product->selling_price - $product->discount}}</span>
