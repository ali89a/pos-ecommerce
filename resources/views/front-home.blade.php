    ...
    <div class="container">
        <div class="row">
            ...
            <div id="content" class="col-xs-12">
                ...
                <div class="owl-carousel product_carousel">
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/iphone_1-200x200.jpg" alt="iPhone5"
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/canon_eos_5d_1-200x200.jpg"
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/samsung_tab_1-200x200.jpg"
                        ...
                        <div class="button-group">
                            <button class="btn-primary" type="button" onClick="cart.add('49');"><span>Add to
                                    Cart</span></button>
                            <div class="add-to-links">
                                <button type="button" data-toggle="tooltip" title="Add to Wish List" onClick=""><i
                                        class="fa fa-heart"></i></button>
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/sony_vaio_1-200x200.jpg"
                        ...
                        <div class="caption">
                            ...
                            <p class="price"> <span class="price-new">$902.00</span> <span
                        ...
                        <div class="button-group">
                            <button class="btn-primary" type="button" onClick="cart.add('46');"><span>Add to
                                    Cart</span></button>
                            <div class="add-to-links">
                                <button type="button" data-toggle="tooltip" title="Add to Wish List" onClick=""><i
                                        class="fa fa-heart"></i></button>
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/macbook_1-200x200.jpg"
                        ...
                        <div class="button-group">
                            <button class="btn-primary" type="button" onClick="cart.add('43');"><span>Add to
                                    Cart</span></button>
                            <div class="add-to-links">
                                <button type="button" data-toggle="tooltip" title="Add to Wish List" onClick=""><i
                                        class="fa fa-heart"></i></button>
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/apple_cinema_30-200x200.jpg"
                        ...
                        <div class="button-group">
                            <button class="btn-primary" type="button" onClick="cart.add('42');"><span>Add to
                                    Cart</span></button>
                            <div class="add-to-links">
                                <button type="button" data-toggle="tooltip" title="Add to Wish List" onClick=""><i
                                        class="fa fa-heart"></i></button>
                ...
                <div class="marketshop-banner">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"><a href="#"><img title="Sample Banner 2"
                                    alt="Sample Banner 2"
                                    src="{{asset('front')}}/image/banner/sample-banner-3-360x360.jpg"></a></div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"><a href="#"><img title="Sample Banner"
                                    alt="Sample Banner"
                                    src="{{asset('front')}}/image/banner/sample-banner-1-360x360.jpg"></a></div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"><a href="#"><img title="Sample Banner 3"
                                    alt="Sample Banner 3"
                                    src="{{asset('front')}}/image/banner/sample-banner-2-360x360.jpg"></a></div>
                    </div>
                </div>
                <!-- Banner End-->
                    ...
                    <div class="category-module-content">
                        ...
                        <div id="tab-cat1" class="tab_content">
                            <div class="owl-carousel latest_category_tabs">
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{asset('front')}}/image/product/macbook_pro_1-200x200.jpg"
                                    ...
                                    <div class="caption">
                                        ...
                                        <p class="price"> <span class="price-new">$1,400.00</span> <span
                                                class="price-old">$1,900.00</span> <span class="saving">-26%</span> </p>
                                    </div>
                                    <div class="button-group">
                                        <button class="btn-primary" type="button" onClick=""><span>Add to
                                                Cart</span></button>
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{asset('front')}}/image/product/macbook_air_1-200x200.jpg"
                                    ...
                                    <div class="caption">
                                        ...
                                        <p class="price"> <span class="price-new">$1,142.00</span> <span
                                                class="price-old">$1,202.00</span> <span class="saving">-5%</span> </p>
                                    </div>
                                    <div class="button-group">
                                        <button class="btn-primary" type="button" onClick=""><span>Add to
                                                Cart</span></button>
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{asset('front')}}/image/product/ipod_shuffle_1-200x200.jpg"
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{asset('front')}}/image/product/ipod_touch_1-200x200.jpg"
                        ...
                        <div id="tab-cat3" class="tab_content">
                            <div class="owl-carousel latest_category_tabs">
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{asset('front')}}/image/product/FinePix-Long-Zoom-Camera-200x200.jpg"
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{asset('front')}}/image/product/nikon_d300_1-200x200.jpg"
                        ...
                        <div id="tab-cat4" class="tab_content">
                            <div class="owl-carousel latest_category_tabs">
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{asset('front')}}/image/product/iphone_1-200x200.jpg"
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{asset('front')}}/image/product/palm_treo_pro_1-200x200.jpg"
                        ...
                        <div id="tab-cat5" class="tab_content">
                            <div class="owl-carousel latest_category_tabs">
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{asset('front')}}/image/product/ipod_classic_1-200x200.jpg"
                                ...
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{asset('front')}}/image/product/ipod_nano_1-200x200.jpg"
                                                alt="Mp3 Player" title="Mp3 Player" class="img-responsive" /></a></div>
                                    <div class="caption">
                                ...
                                <div class="product-thumb">
                                    ...
                                    <div class="button-group">
                                        <button class="btn-primary" type="button" onClick="cart.add('34');"><span>Add to
                                                Cart</span></button>
                                        <div class="add-to-links">
                                            <button type="button" data-toggle="tooltip" title="Add to wishlist"
                        ...
                        <div id="tab-cat6" class="tab_content">
                            <div class="owl-carousel latest_category_tabs">
                                <div class="product-thumb">
                                    ...
                                    <div class="button-group">
                                        <button class="btn-primary" type="button" onClick="cart.add('48');"><span>Add to
                                                Cart</span></button>
                                        <div class="add-to-links">
                                            <button type="button" data-toggle="tooltip" title="Add to wishlist"
                                                onClick=""><i class="fa fa-heart"></i></button>
                ...
                <div class="owl-carousel latest_category_carousel">
                    <div class="product-thumb">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/iphone_6-200x200.jpg"
                    ...
                    <div class="product-thumb">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/nikon_d300_5-200x200.jpg"
                    ...
                    <div class="product-thumb">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/nikon_d300_4-200x200.jpg"
                                    alt="Bed Head Foxy Curls Contour Cream" title="Bed Head Foxy Curls Contour Cream"
                                    class="img-responsive" /></a></div>
                        <div class="caption">
                    ...
                    <div class="product-thumb">
                        <div class="image"><a href="#"><img src="{{asset('front')}}/image/product/macbook_5-200x200.jpg"
                        ...
                        <div class="button-group">
                            <button class="btn-primary" type="button" onClick="cart.add('61');"><span>Add to
                                    Cart</span></button>
                            <div class="add-to-links">
                                <button type="button" data-toggle="tooltip" title="Add to wishlist"
                    ...
                    <div class="product-thumb">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/macbook_4-200x200.jpg"
                    ...
                    <div class="product-thumb">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/macbook_3-200x200.jpg"
                                    alt="Make Up for Naturally Beautiful Better"
                                    title="Make Up for Naturally Beautiful Better" class="img-responsive" /></a></div>
                        <div class="caption">
                    ...
                    <div class="product-thumb">
                        <div class="image"><a href="product.html"><img
                                    src="{{asset('front')}}/image/product/macbook_2-200x200.jpg"
                ...
                <div class="marketshop-banner">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> <a href="#"><img title="1 Block Banner"
                                    alt="1 Block Banner"
                                    src="{{asset('front')}}/image/banner/1blockbanner-1140x75.jpg"></a></div>
                    </div>
                </div>
                <!-- Banner End -->
                ...
                <div id="carousel" class="owl-carousel nxt">
                    <div class="item text-center"> <a href="#"><img
                                src="{{asset('front')}}/image/product/apple_logo-100x100.jpg" alt="Palm"
                                class="img-responsive" /></a> </div>
                    <div class="item text-center"> <a href="#"><img
                                src="{{asset('front')}}/image/product/canon_logo-100x100.jpg" alt="Sony"
                                class="img-responsive" /></a> </div>
                    <div class="item text-center"> <a href="#"><img
                                src="{{asset('front')}}/image/product/apple_logo-100x100.jpg" alt="Canon"
                                class="img-responsive" /></a> </div>
                    <div class="item text-center"> <a href="#"><img
                                src="{{asset('front')}}/image/product/canon_logo-100x100.jpg" alt="Apple"
                                class="img-responsive" /></a> </div>
                    <div class="item text-center"> <a href="#"><img
                                src="{{asset('front')}}/image/product/apple_logo-100x100.jpg" alt="HTC"
                                class="img-responsive" /></a> </div>
                    <div class="item text-center"> <a href="#"><img
                                src="{{asset('front')}}/image/product/canon_logo-100x100.jpg" alt="Hewlett-Packard"
                                class="img-responsive" /></a> </div>
                    <div class="item text-center"> <a href="#"><img
