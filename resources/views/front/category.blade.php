                            ...
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="product.html" target="_self" title="Chicken swinesha">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/1.jpg"
                                            class="img-1 img-responsive" alt="image">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/2.jpg"
                        ...
                        <div class="product-item-container">
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="product.html" target="_self" title="Cupim should ">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/3.jpg"
                                            class="img-1 img-responsive" alt="image">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/4.jpg"
                                            class="img-2 img-responsive" alt="image">
                                    </a>
                                </div>
                                <div class="button-group so-quickview cartinfo--left">
                            ...
                            <div class="right-block">
                                <div class="caption">
                                    ...
                                    <h4><a href="product.html" title="Cupim should " target="_self">Cupim should </a>
                                    </h4>
                        ...
                        <div class="product-item-container">
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="product.html" target="_self" title="Doenpuis consuat ">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/5.jpg"
                                            class="img-1 img-responsive" alt="image">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/6.jpg"
                                            class="img-2 img-responsive" alt="image">
                                    </a>
                                </div>
                            ...
                            <div class="right-block">
                                <div class="caption">
                                    ...
                                    <h4><a href="product.html" title="Doenpuis consuat " target="_self">Doenpuis consuat
                                        </a></h4>
                        ...
                        <div class="product-item-container">
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="product.html" target="_self" title="Drutick lanaeger">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/7.jpg"
                                            class="img-1 img-responsive" alt="image">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/8.jpg"
                                            class="img-2 img-responsive" alt="image">
                                    </a>
                                </div>
                                <div class="button-group so-quickview cartinfo--left">
                            ...
                            <div class="right-block">
                                <div class="caption">
                                    ...
                                    <h4><a href="product.html" title="Drutick lanaeger" target="_self">Drutick
                                            lanaeger</a></h4>
                        ...
                        <div class="product-item-container">
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="product.html" target="_self" title="Ercitation incididunt">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/9.jpg"
                                            class="img-1 img-responsive" alt="image">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/10.jpg"
                                            class="img-2 img-responsive" alt="image">
                                    </a>
                                </div>
                                <div class="button-group so-quickview cartinfo--left">
                            ...
                            <div class="right-block">
                                <div class="caption">
                                    ...
                                    <h4><a href="product.html" title="Ercitation incididunt" target="_self">Ercitation
                                            incididunt</a></h4>
                            ...
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="product.html" target="_self" title="Fatback picanha">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/11.jpg"
                                            class="img-1 img-responsive" alt="image">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/12.jpg"
                                            class="img-2 img-responsive" alt="image">
                                    </a>
                                </div>
                            ...
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="product.html" target="_self" title="Jalapeno dolore">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/13.jpg"
                                            class="img-1 img-responsive" alt="image">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/14.jpg"
                                            class="img-2 img-responsive" alt="image">
                                    </a>
                                </div>
                                <div class="button-group so-quickview cartinfo--left">
                        ...
                        <div class="product-item-container">
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="product.html" target="_self" title="Mapicola incididuv">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/15.jpg"
                                            class="img-1 img-responsive" alt="image">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/16.jpg"
                                            class="img-2 img-responsive" alt="image">
                                    </a>
                                </div>
                                <div class="box-label"><span class="label-product label-new"> New </span>
                            ...
                            <div class="right-block">
                                <div class="caption">
                                    ...
                                    <h4><a href="product.html" title="Mapicola incididuv" target="_self">Mapicola
                                            incididuv</a></h4>
                        ...
                        <div class="product-item-container">
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="product.html" target="_self" title="Ullamco occaeca">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/17.jpg"
                                            class="img-1 img-responsive" alt="image">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/18.jpg"
                                            class="img-2 img-responsive" alt="image">
                                    </a>
                                </div>
                                <div class="button-group so-quickview cartinfo--left">
                            ...
                            <div class="right-block">
                                <div class="caption">
                                    ...
                                    <h4><a href="product.html" title="Ullamco occaeca" target="_self">Ullamco
                                            occaeca</a></h4>
                            ...
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="product.html" target="_self" title="Pariatur porking">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/19.jpg"
                                            class="img-1 img-responsive" alt="image">
                                        <img src="{{ asset('front') }}/image/catalog/demo/product/funiture/20.jpg"
                                            class="img-2 img-responsive" alt="image">
                                    </a>
                                </div>
                                <div class="button-group so-quickview cartinfo--left">
