...
<div class="main-container container">
    <ul class="breadcrumb">
        ...
        <li><a href="{{ route('best.seller') }}">Best Seller Products</a>
        </li>
    </ul>
    <div class="row">
        <!--Left Part Start -->
        ...
        <div id="content" class="col-md-9 col-sm-8">
            <div class="products-category">
                ...
                <div class="products-list row nopadding-xs so-filter-gird">
                    @forelse($best_seller_products as $product)
                        ...
                        <div class="product-item-container">
                            <div class="left-block">
                                ...
                                <div class="button-group so-quickview cartinfo--left">
                                    ...
                                    {{-- <!--quickview--> <a class="iframe-link btn-button quickview quickview_handler visible-lg" href="{{route('single.product',$product->slug)}}"
                                    title="Quick view" data-fancybox-type="iframe"><i class="fa fa-eye">
