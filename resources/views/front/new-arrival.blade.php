                        ...
                        <div class="product-item-container">
                            <div class="left-block">
                                ...
                                <div class="button-group so-quickview cartinfo--left">
                                    ...
                                    <!--quickview--> <a class="iframe-link btn-button quickview quickview_handler visible-lg" 
                                    href="{{route('single.product',$product->slug)}}" title="Quick view" data-fancybox-type="iframe">
