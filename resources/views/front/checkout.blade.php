								...
								<fieldset id="account">
									...
									<div class="form-group required">
										...
										<input type="text" class="form-control" id="input-payment-telephone"
											placeholder="Mobile" value="" name="mobile">
									</div>
								...
								<fieldset id="address" class="required">
									<div class="form-group required">
										...
										<input type="text" class="form-control" id="input-payment-address-1"
											placeholder="Address 1" value="" name="address">
									</div>
								...
								<div class="panel panel-default no-padding">
									...
									<div class="col-sm-6  checkout-payment-methods">
										...
										<div class="panel-body">
											...
											<div class="radio">
												<label><input type="radio" name="payment_method" value="Cash">Cash On
													Delivery</label>
											</div>
											<div class="radio">
												<label>
											...
											<table class="table table-bordered">
												...
												<tbody>
													...
													<tr>
														...
														<td class="text-center"> <a
																href="{{route('single.product',$row->options->slug)}}"><img
																	src="{{asset('storage/'.$row->options->img_url)}}"
																	style="height: 50px;" alt="Pariatur porking"
																	title="Pariatur porking" class="img-thumbnail"></a>
														</td>
														...
														<td class="text-right">&#x9F3; <?php echo $row->priceTotal; ?>
														</td>
													</tr>
													@php
													$total += $row->subtotal;
												...
												<tfoot>
													<tr>
														...
														<td class="text-right">&#x9F3; <?php echo Cart::subtotal(); ?>
														</td>
														<input type="hidden" value="{{$total}}" name="subtotal">
													</tr>
													<tr>
														<td class="text-right" colspan="4"><strong>Coupon
																Discount:</strong></td>
