...
<!-- Mirrored from demo.smartaddons.com/templates/html/emarket/quickview.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Jan 2021 03:54:32 GMT -->
...
<head>
							...
							<div id="product">
								...
								<div class="image_option_type form-group required">
									...
									<ul class="product-options clearfix"id="input-option231">
										...
										<li class="radio">
											<label>
												<input class="image_radio" type="radio" name="option[231]" value="35"> <img src="{{ asset('front') }}/image/demo/colors/green.jpg"
 ...
 <script type="text/javascript" src="{{ asset('front') }}/js/theme/js/libs.js"></script>
